...
Aslab memiliki tombol Approve (mengubah status menjadi "Sedang Dipinjam" dan mengurangi stok).

Aslab memiliki tombol Returned (mengubah status menjadi "Sudah Dikembalikan" dan menambah stok kembali).
